...
Hiện trạng: **13 node types, catalog live ~1.240 model (576 ảnh + 319 video fal + 345 LLM) + 48 preset ⭐, 11 samples, 497 server + 20 shared + 402 web + 35 e2e tests.** Backlog UX 2026-07-13 đã xong toàn bộ (steps 31–32). Việc sau này: tính năng mới theo yêu cầu user, vẫn theo luật orchestration ở trên. Nợ nhỏ đã biết: e2e app.spec test 19 (auto-split khi chọn conversation) thi thoảng flaky pass-on-retry (tiền sử từ step 23, không thuộc diff 31/32).
